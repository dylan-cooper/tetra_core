defmodule TetraCore.IRCPlayer do

end

defmodule TetraCore.ExampleApplication do
  use Application
  ...
  def start(_type, _args) do
    ...
    children = [
      ...
      worker(TetraCore.ExampleConnectionHandler, [client]),
      # here's where we specify the channels to join:
      worker(TetraCore.ExampleLoginHandler, [client, ["#tetra-testing"]])
    ]
...
defmodule TetraCore.ExampleConnectionHandler do
  defmodule State do
...
defmodule TetraCore.ExampleLoginHandler do
  @moduledoc """
